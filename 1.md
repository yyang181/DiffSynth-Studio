...
CUDA_VISIBLE_DEVICES=1 torchrun --standalone --nproc_per_node=1 examples/wanvideo/model_inference/test.py --checkpoint exp/train/Wan2.1-VACE-1.3B_full/epoch-1.safetensors
...
accelerate launch --mixed_precision=bf16 \
  ...
  --num_epochs 1000000000000000 \
  --remove_prefix_in_ckpt "pipe.vace." \
  --output_path "./exp/train/sr_Wan2.1-VACE-1.3B_full" \
  --trainable_models "vace" \
  --extra_inputs "vace_video,vace_reference_image" \
  --use_gradient_checkpointing_offload --use_swanlab --swanlab_mode cloud 
