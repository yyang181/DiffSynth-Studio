...
CUDA_VISIBLE_DEVICES=0 torchrun --standalone --nproc_per_node=1 examples/wanvideo/model_inference/sr_test_batch.py --checkpoint exp/train/sr_vace_datapth_8gpu_resume19_resume58
...
CUDA_VISIBLE_DEVICES=0 torchrun --standalone --nproc_per_node=1 examples/wanvideo/model_inference/sr_vacefull_test_batch.py --checkpoint exp/train/sr_vacefull/epoch-4.safetensors
...
accelerate launch --mixed_precision=bf16 \
  ...
  --output_path "./exp/train/sr_vacefull" \
